...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-etNP-e1H.mjs");
...
const manifest = {
  "929d9f7095fbe62a722f75744884bbdff66afbb0eee18001e836d24975da7911": {
    functionName: "deleteUserAccount_createServerFn_handler",
    importer: () => import("./auth.functions-BUI8l78k.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BsP_EZBf.mjs").then((n) => n.r),
    import("./start-DIq2VjBd.mjs"),
